...
```mermaid
graph LR
    A[1. Discovery<br/>Understand your<br/>business goals] --> B[2. Data Audit<br/>Assess what<br/>you have]
    B --> C[3. Solution Design<br/>Map features to<br/>outcomes]
    C --> D[4. Build & Iterate<br/>Rapid prototyping]
    D --> E[5. Deploy & Train<br/>Your team owns it]
    
    style A fill:#2563EB,stroke:#1e40af,stroke-width:3px,color:white
    style B fill:#3b82f6,stroke:#1e40af,stroke-width:2px,color:white
    style C fill:#60a5fa,stroke:#1e40af,stroke-width:2px,color:white
    style D fill:#FF6B35,stroke:#c2410c,stroke-width:2px,color:white
    style E fill:#2563EB,stroke:#1e40af,stroke-width:3px,color:white
```
...
[![Portfolio](https://img.shields.io/badge/Portfolio-mqanass.github.io-FF6B35?style=for-the-badge&logo=github&logoColor=white)](https://mqanass.github.io/)
